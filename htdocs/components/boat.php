...
<script type="text/javascript">
		...
		<div id="content">
			...
			<div class="column2">
				...
				<div id="side-images">
				<?php 
				$images = getGalleryImages($page, 'boat');
				...
				$('#side-images').find('a').on('click', function() {
					if(ga)ga('send', 'event', 'image', 'click', 'boat', 1);
				});
				</script>
				<?php if(_STAGING_){ ?>
					<div class="cms-ui" <?php echo getCMSForm('boat-gallery'); ?> style="text-align: right">Double click to change gallery...</div>
				<?php } ?>
			</div>
